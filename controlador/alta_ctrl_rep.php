    ...
    <div class="container">
        <form action="proceso_registro_in.php" method="post" class="registro-form">
            ...
            <select name="tipo" class="select-tipo" onchange="window.location.href='alta_ctrl_rep.php?tipo=' + this.value" required>
                ...
                <?php
                    $tipo = isset($_GET['tipo']) ? $_GET['tipo'] : 'Controlador';

                    if ($tipo === 'Controlador') {
                        echo "<option value='Controlador' class='option-tipo' selected>Controlador</option>";
                        echo "<option value='Repartidor' class='option-tipo'>Repartidor</option>";
                    } else {
                        echo "<option value='Controlador' class='option-tipo'>Controlador</option>";
                        echo "<option value='Repartidor' class='option-tipo' selected>Repartidor</option>";
                    }
                ?>
            </select>
